...
class Axiom:
    ...
    def _suscribir(self) -> None:
        ...
        # La serie de BTC va como suscriptor SEPARADO de las velas de pares:
    ...
    async def _capturar_btc(self, evento) -> dict:
        """
    ...
    async def _capturar_opciones(self, evento) -> dict:
        """
        ...
        """
        cadena = await opciones.capturar(self.pool)
    ...
    async def _refrescar_coins(self):
        ...
        try:
            corr = await captura_correlacion.actualizar(self.pool, self.fuentes)
        except Exception:
    ...
    async def estado(self) -> dict:
        return {
            ...
            "funding": await funding.estado(self.pool),
